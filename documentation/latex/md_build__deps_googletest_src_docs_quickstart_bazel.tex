This tutorial aims to get you up and running with Google\+Test using the Bazel build system. If you\textquotesingle{}re using Google\+Test for the first time or need a refresher, we recommend this tutorial as a starting point.\hypertarget{md_build__deps_googletest_src_docs_quickstart_bazel_autotoc_md234}{}\doxysection{Prerequisites}\label{md_build__deps_googletest_src_docs_quickstart_bazel_autotoc_md234}
...
\{\+: .callout .note\} Note\+: The terminal commands in this tutorial show a Unix shell prompt, but the commands work on the Windows command line as well.\hypertarget{md_build__deps_googletest_src_docs_quickstart_bazel_autotoc_md235}{}\doxysection{Set up a Bazel workspace}\label{md_build__deps_googletest_src_docs_quickstart_bazel_autotoc_md235}
...
Now you\textquotesingle{}re ready to build C++ code that uses Google\+Test.\hypertarget{md_build__deps_googletest_src_docs_quickstart_bazel_autotoc_md236}{}\doxysection{Create and run a binary}\label{md_build__deps_googletest_src_docs_quickstart_bazel_autotoc_md236}
...
Congratulations! You\textquotesingle{}ve successfully built and run a test binary using Google\+Test.\hypertarget{md_build__deps_googletest_src_docs_quickstart_bazel_autotoc_md237}{}\doxysection{Next steps}\label{md_build__deps_googletest_src_docs_quickstart_bazel_autotoc_md237}
