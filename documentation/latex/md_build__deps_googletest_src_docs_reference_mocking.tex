...
See details for each modifier clause below.\hypertarget{md_build__deps_googletest_src_docs_reference_mocking_autotoc_md263}{}\doxysubsubsection{With \{\#\+EXPECT\+\_\+\+CALL.\+With\}}\label{md_build__deps_googletest_src_docs_reference_mocking_autotoc_md263}
...
The {\ttfamily With} clause can be used at most once on an expectation and must be the first clause.\hypertarget{md_build__deps_googletest_src_docs_reference_mocking_autotoc_md264}{}\doxysubsubsection{Times \{\#\+EXPECT\+\_\+\+CALL.\+Times\}}\label{md_build__deps_googletest_src_docs_reference_mocking_autotoc_md264}
...
The {\ttfamily Times} clause can be used at most once on an expectation.\hypertarget{md_build__deps_googletest_src_docs_reference_mocking_autotoc_md265}{}\doxysubsubsection{In\+Sequence \{\#\+EXPECT\+\_\+\+CALL.\+In\+Sequence\}}\label{md_build__deps_googletest_src_docs_reference_mocking_autotoc_md265}
{\ttfamily .In\+Sequence(}$\ast${\ttfamily sequences...}$\ast${\ttfamily )}

Specifies that the mock function call is expected in a certain sequence.

The parameter $\ast${\ttfamily sequences...}$\ast$ is any number of \mbox{\hyperlink{md_build__deps_googletest_src_docs_reference_mocking_Sequence}{\`{}\+Sequence\`{}}} objects. Expected calls assigned to the same sequence are expected to occur in the order the expectations are declared.
...
See also the \mbox{\hyperlink{md_build__deps_googletest_src_docs_reference_mocking_InSequence}{\`{}\+In\+Sequence\`{} class}}.\hypertarget{md_build__deps_googletest_src_docs_reference_mocking_autotoc_md266}{}\doxysubsubsection{After \{\#\+EXPECT\+\_\+\+CALL.\+After\}}\label{md_build__deps_googletest_src_docs_reference_mocking_autotoc_md266}
...
The parameter $\ast${\ttfamily expectations...}$\ast$ can be up to five \mbox{\hyperlink{md_build__deps_googletest_src_docs_reference_mocking_Expectation}{\`{}\+Expectation\`{}}} or \mbox{\hyperlink{md_build__deps_googletest_src_docs_reference_mocking_ExpectationSet}{\`{}\+Expectation\+Set\`{}}} objects. The mock function call is expected to occur after all of the given expectations.
...
The {\ttfamily After} clause can be used any number of times on an expectation.\hypertarget{md_build__deps_googletest_src_docs_reference_mocking_autotoc_md267}{}\doxysubsubsection{Will\+Once \{\#\+EXPECT\+\_\+\+CALL.\+Will\+Once\}}\label{md_build__deps_googletest_src_docs_reference_mocking_autotoc_md267}
...
The {\ttfamily Will\+Once} clause can be used any number of times on an expectation. Unlike {\ttfamily Will\+Repeatedly}, the action fed to each {\ttfamily Will\+Once} call will be called at most once, so may be a move-\/only type and/or have an {\ttfamily \&\&}-\/qualified call operator.\hypertarget{md_build__deps_googletest_src_docs_reference_mocking_autotoc_md268}{}\doxysubsubsection{Will\+Repeatedly \{\#\+EXPECT\+\_\+\+CALL.\+Will\+Repeatedly\}}\label{md_build__deps_googletest_src_docs_reference_mocking_autotoc_md268}
...
The {\ttfamily Will\+Repeatedly} clause can be used at most once on an expectation.\hypertarget{md_build__deps_googletest_src_docs_reference_mocking_autotoc_md269}{}\doxysubsubsection{Retires\+On\+Saturation \{\#\+EXPECT\+\_\+\+CALL.\+Retires\+On\+Saturation\}}\label{md_build__deps_googletest_src_docs_reference_mocking_autotoc_md269}
...
See details for each modifier clause below.\hypertarget{md_build__deps_googletest_src_docs_reference_mocking_autotoc_md270}{}\doxysubsubsection{With \{\#\+ON\+\_\+\+CALL.\+With\}}\label{md_build__deps_googletest_src_docs_reference_mocking_autotoc_md270}
{\ttfamily .With(}$\ast${\ttfamily multi\+\_\+argument\+\_\+matcher}$\ast${\ttfamily )}
...
The {\ttfamily With} clause can be used at most once with each {\ttfamily ON\+\_\+\+CALL} statement.\hypertarget{md_build__deps_googletest_src_docs_reference_mocking_autotoc_md271}{}\doxysubsubsection{Will\+By\+Default \{\#\+ON\+\_\+\+CALL.\+Will\+By\+Default\}}\label{md_build__deps_googletest_src_docs_reference_mocking_autotoc_md271}
...
{\ttfamily \mbox{\hyperlink{classtesting_1_1DefaultValue}{testing\+::\+Default\+Value}}\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}}
...
{\ttfamily \mbox{\hyperlink{classtesting_1_1NiceMock}{testing\+::\+Nice\+Mock}}\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}}
...
{\ttfamily Nice\+Mock\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}} might not work correctly if the destructor of {\ttfamily T} is not virtual.\hypertarget{md_build__deps_googletest_src_docs_reference_mocking_NaggyMock}{}\doxysubsection{Naggy\+Mock}\label{md_build__deps_googletest_src_docs_reference_mocking_NaggyMock}
{\ttfamily \mbox{\hyperlink{classtesting_1_1NaggyMock}{testing\+::\+Naggy\+Mock}}\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}}
...
\mbox{\hyperlink{classMock}{Mock}} objects of type {\ttfamily T} by default behave the same way as {\ttfamily Naggy\+Mock\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}}.\hypertarget{md_build__deps_googletest_src_docs_reference_mocking_StrictMock}{}\doxysubsection{Strict\+Mock}\label{md_build__deps_googletest_src_docs_reference_mocking_StrictMock}
{\ttfamily \mbox{\hyperlink{classtesting_1_1StrictMock}{testing\+::\+Strict\+Mock}}\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}}
...
{\ttfamily Strict\+Mock\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}} might not work correctly if the destructor of {\ttfamily T} is not virtual.\hypertarget{md_build__deps_googletest_src_docs_reference_mocking_Sequence}{}\doxysubsection{Sequence}\label{md_build__deps_googletest_src_docs_reference_mocking_Sequence}
{\ttfamily \+::testing\+::\+Sequence}

Represents a chronological sequence of expectations. See the \`{}\+In\+Sequence\`{} clause of {\ttfamily EXPECT\+\_\+\+CALL} for usage.\hypertarget{md_build__deps_googletest_src_docs_reference_mocking_InSequence}{}\doxysubsection{In\+Sequence}\label{md_build__deps_googletest_src_docs_reference_mocking_InSequence}
...
Represents a mock function call expectation as created by \mbox{\hyperlink{md_build__deps_googletest_src_docs_reference_mocking_EXPECT_CALL}{\`{}\+EXPECT\+\_\+\+CALL\`{}}}\+:
...
Useful for specifying sequences of expectations; see the \`{}\+After\`{} clause of {\ttfamily EXPECT\+\_\+\+CALL}.\hypertarget{md_build__deps_googletest_src_docs_reference_mocking_ExpectationSet}{}\doxysubsection{Expectation\+Set}\label{md_build__deps_googletest_src_docs_reference_mocking_ExpectationSet}
{\ttfamily \+::testing\+::\+Expectation\+Set}

Represents a set of mock function call expectations.

Use the {\ttfamily +=} operator to add \mbox{\hyperlink{md_build__deps_googletest_src_docs_reference_mocking_Expectation}{\`{}\+Expectation\`{}}} objects to the set\+:
