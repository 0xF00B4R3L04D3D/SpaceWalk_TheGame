...
\label{sample1_8h_source}\index{build/\_deps/googletest-\/src/googletest/samples/sample1.h@{build/\_deps/googletest-\/src/googletest/samples/sample1.h}}
...
\DoxyCodeLine{31 }
\DoxyCodeLine{32 \textcolor{preprocessor}{\#ifndef GOOGLETEST\_SAMPLES\_SAMPLE1\_H\_}}
\DoxyCodeLine{33 \textcolor{preprocessor}{\#define GOOGLETEST\_SAMPLES\_SAMPLE1\_H\_}}
\DoxyCodeLine{34 }
\DoxyCodeLine{35 \textcolor{comment}{// Returns n! (the factorial of n).  For negative n, n! is defined to be 1.}}
\DoxyCodeLine{36 \textcolor{keywordtype}{int} Factorial(\textcolor{keywordtype}{int} n);}
\DoxyCodeLine{37 }
\DoxyCodeLine{38 \textcolor{comment}{// Returns true if and only if n is a prime number.}}
\DoxyCodeLine{39 \textcolor{keywordtype}{bool} IsPrime(\textcolor{keywordtype}{int} n);}
\DoxyCodeLine{40 }
\DoxyCodeLine{41 \textcolor{preprocessor}{\#endif  }\textcolor{comment}{// GOOGLETEST\_SAMPLES\_SAMPLE1\_H\_}}
