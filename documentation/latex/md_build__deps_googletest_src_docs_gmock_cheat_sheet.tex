\hypertarget{md_build__deps_googletest_src_docs_gmock_cheat_sheet_autotoc_md112}{}\doxysection{Defining a Mock Class}\label{md_build__deps_googletest_src_docs_gmock_cheat_sheet_autotoc_md112}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_docs_gmock_cheat_sheet_autotoc_md113}{}\doxysubsection{Specifying Calling Conventions for Mock Functions}\label{md_build__deps_googletest_src_docs_gmock_cheat_sheet_autotoc_md113}
...
where {\ttfamily STDMETHODCALLTYPE} is defined by {\ttfamily \texorpdfstring{$<$}{<}objbase.\+h\texorpdfstring{$>$}{>}} on Windows.\hypertarget{md_build__deps_googletest_src_docs_gmock_cheat_sheet_UsingMocks}{}\doxysection{Using Mocks in Tests}\label{md_build__deps_googletest_src_docs_gmock_cheat_sheet_UsingMocks}
...
See the \href{reference/mocking.md\#EXPECT_CALL.Times}{\texttt{ {\ttfamily Times} clause}} of {\ttfamily EXPECT\+\_\+\+CALL} in the Mocking Reference.\hypertarget{md_build__deps_googletest_src_docs_gmock_cheat_sheet_autotoc_md114}{}\doxysection{Expectation Order}\label{md_build__deps_googletest_src_docs_gmock_cheat_sheet_autotoc_md114}
By default, expectations can be matched in {\itshape any} order. If some or all expectations must be matched in a given order, you can use the \href{reference/mocking.md\#EXPECT_CALL.After}{\texttt{ {\ttfamily After} clause}} or \href{reference/mocking.md\#EXPECT_CALL.InSequence}{\texttt{ {\ttfamily In\+Sequence} clause}} of {\ttfamily EXPECT\+\_\+\+CALL}, or use an \href{reference/mocking.md\#InSequence}{\texttt{ {\ttfamily In\+Sequence} object}}.\hypertarget{md_build__deps_googletest_src_docs_gmock_cheat_sheet_autotoc_md115}{}\doxysection{Verifying and Resetting a Mock}\label{md_build__deps_googletest_src_docs_gmock_cheat_sheet_autotoc_md115}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_docs_gmock_cheat_sheet_autotoc_md116}{}\doxysection{Mock Classes}\label{md_build__deps_googletest_src_docs_gmock_cheat_sheet_autotoc_md116}
...
See this \href{gmock_cook_book.md\#UsingCheckPoints}{\texttt{ recipe}} for one application of it.\hypertarget{md_build__deps_googletest_src_docs_gmock_cheat_sheet_autotoc_md117}{}\doxysection{Flags}\label{md_build__deps_googletest_src_docs_gmock_cheat_sheet_autotoc_md117}
\tabulinesep=1mm
